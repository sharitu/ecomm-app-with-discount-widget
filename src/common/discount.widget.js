...
const getDiscount = (price) => {
  ...
  if (price < 20)
    return {
      percent: 0,
      discountedPrice: Math.round(((price) + Number.EPSILON) * 100) / 100,
    };
  ...
  if (price < 100)
    return {
      percent: 20,
      discountedPrice: Math.round(((price * 0.8) + Number.EPSILON) * 100) / 100,
    };
  ...
  if (price < 500)
    return {
      percent: 30,
      discountedPrice: Math.round(((price * 0.7) + Number.EPSILON) * 100) / 100,
    };

  // 40% discount if the cost of the item is $500 or more.
  return {
    percent: 40,
    discountedPrice: Math.round(((price * 0.6) + Number.EPSILON) * 100) / 100,
  };
};
